...
// const Footer = () => {
//   return (
//     <div className="theme-zinc bg-[#101015] rounded-md w-full">
//       <div className="preview bg-[#101015] flex min-h-[350px] w-full justify-center p-2 sm:p-10 items-center">
//         <div className="border-white/[0.1] border-t bg-[#101015] shadow-lg px-8 py-20 w-full relative overflow-hidden">
//           <div className="max-w-7xl mx-auto text-sm text-[#A3A3C2] flex sm:flex-row flex-col justify-between items-start md:px-8">
//             <div>
...
//                     /> */}
//                   <span className="font-medium text-[#A3A3C2]">
//                     Online Expert LTD.
//                   </span>
//                 </a>
//               </div>
...
//               </div>
//             </div>
//             <div className="grid grid-cols-2 lg:grid-cols-4 text-[#A3A3C2] gap-10 items-start mt-10 sm:mt-0 md:mt-0">
...
//                 <p className="transition-colors cursor-pointer hover:text-neutral-800 text-[#A3A3C2] font-semibold">
//                   Socials
//                 </p>
//                 <ul className="list-none space-y-4">
//                   <li>
...
//               </div>
//               <div className="flex justify-center space-y-4 flex-col">
//                 <p className="transition-colors cursor-pointer hover:text-neutral-800 text-[#A3A3C2]  font-demibold">
//                   Register
//                 </p>
//                 <ul className="list-none space-y-4">
//                   <li>
